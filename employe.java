...
class Salary {
    public static void main(String[] args) {
        ...
        p.ajouterEmploye(new Vendeur( " de matricule 15A999FS", "NGAMA", "ANDRE", 30, "en service depuis le 12 fevrier 2012", 30000.0));
        p.ajouterEmploye(new Representant( "15A748FS", "TATONTE", "JEAN", 25, "en service depuis le 15 janvier 2001", 20000.0));
        p.ajouterEmploye(new Technicien( "15A747FS", "HAYWA","CHLODE", 21, " en service depuis le 15 avril 1998", 1000));
        p.ajouterEmploye(new Manutentionnaire( "15A746FS", "michou", "george", 32, "en service depuis le 12 decembre 1998", 45));
        p.ajouterEmploye(new TechnARisque( "15A745FS", "guogue", "franois", 28, " en service depuis le 10 mai 2000", 1000));
        p.ajouterEmploye(new ManutARisque( "15A744FS", "DRADA", "BLAISE", 30, "en service depuis le 15 novembre 2001", 45));
